...
class UserDetailsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'is_active' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '1=Yes/0=No', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'is_active' => 1,
            'created' => '2016-08-18 05:21:44',
            'modified' => '2016-08-18 05:21:44'
        ],
    ];
}
