<div id="navbar" class="navbar navbar-default ace-save-state" style="background: #bbb;">
    <div class="main-container ace-save-state container" id="main-container" style="background: #f1f1f1;">
        <div class="merchant-header">
            ...
            <div class="logo-center"><img src="<?= !empty($userDetails['merchant_profile']['logo']) ? MERCHANT_LOGO . $userDetails['merchant_profile']['logo'] : 'img/logo/web-info-mart-logo.png' ?>" /></div>
...
<?php /* ?>
  ...
  <small>Welcome,</small>
  <?= !empty($userDetails['name']) ? $userDetails['name'] : 'Merchnat' ?>
  </span>
  ...
  <li>
  <a href="<?= HTTP_ROOT . 'merchant/#/change-password' ?>">
  ...
  <li>
  <a href="<?= HTTP_ROOT . 'merchant/#/profile-setting' ?>">
