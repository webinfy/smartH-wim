    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> View Merchants Branch Wise  </li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">  
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <h3 class="header smaller lighter blue"> View Merchants Branch Wise  </h3>
                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-4">
                                    <select name="search_by" class="validate[required] form-control input-sm" id="SearchBY">
                                        ...
                                        <option value="merchant_name">Branch</option>
                                        <option value="due_amount"> Merchant Name </option>                                                                              
                                    </select>
                                </div>
                            ...
                            <tbody>
                                ...
                                <?php for ($i = 0; $i < 4; $i++) { ?>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td style="text-align: center;">
                                            <a href="<?= HTTP_ROOT . "admin/view-customers/1" ?>"><span class="label label-sm label-success arrowed arrowed-righ">View Customers</span></a>
                                        </td>
