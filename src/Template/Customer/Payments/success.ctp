                                    ...
                                    <div class="content-main-area">
                                        ...
                                        <table id="t01">
                                            ...
                                            <tr>
                                                ...
                                                <?php if ($payment->paid_amount == ($payment->fee + $payment->convenience_fee_amount + $payment->late_fee_amount)) { ?>
                                                    <th>Late Fee </th>  
                                                <?php } ?>
                                            </tr>
                                            <tr>
                                            ...
                                            <?php
                                            $colspan = count($paymentCustomFields) + 1 + (($payment->paid_amount == ($payment->fee + $payment->convenience_fee_amount + $payment->late_fee_amount)) ? 1 : 0);
