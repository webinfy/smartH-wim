    ...
    <div class="main-content-inner">
        ...
        <div class="breadcrumbs ace-save-state" id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active"> Upcoming Payments </li>
            </ul><!-- /.breadcrumb -->
        ...
        <div class="page-content">  
            ...
            <div class="row">
                <div class="col-xs-12">
                    <h3 class="header smaller lighter blue"> Upcoming Payments  </h3>
                                ...
                                <?php for ($i = 0; $i < 4; $i++) { ?>
                                    ...
                                    <tr>                                    
                                        ...
                                        <td style="text-align: center;">
                                            <span class="label label-sm label-warning arrowed arrowed-righ">Paid</span>
                                        </td>
                                        ...
                                        <td style="text-align: center;">
                                            ...
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                ...
                                                <a class="green " href="<?php echo HTTP_ROOT . "customer/pay-now" ?>">                                                   
                                                    <button class="btn btn-xs btn-success">
                                                        <i class="ace-icon fa fa-check bigger-120"></i> Pay Now
                                                    </button>
                                                </a> 
